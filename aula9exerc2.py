...
st.bar_chart(df['NM_MUNIC'].value_counts().sort_values(ascending=False)[:10])#seleciona os 10 municípios com mais comunidades
st.bar_chart(df_dezmunic) #apresenta o gráfico de barras dos 10 municípios com mais comunidades
